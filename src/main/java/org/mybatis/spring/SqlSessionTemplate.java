...
public class SqlSessionTemplate implements SqlSession, DisposableBean {
  ...
  /**
   * 内部类：
   * 实现jdk动态代理处理接口InvocationHandler，对SqlSession进行代理，获取DefaultSqlSession并执行原方法
